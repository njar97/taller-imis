...
async function generarPdfDirecto(html, filename) {
  ...
  //    o left:-99999 hacían que se capturara como blanco). Lo tapamos con
  //    un overlay opaco sobre todo. Se borra al terminar.
  const wrap = document.createElement('div');
  wrap.id = 'etiq-pdf-wrap';
  wrap.style.cssText = 'position:absolute;left:0;top:0;width:8.5in;background:white;z-index:0;pointer-events:none;';
